...
namespace PROJECT {
    ...
    public partial class CustomerDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustomersRow AddCustomersRow(string Ad, string Soyad, string Adres, string Eposta, System.DateTime Created_date) {
...
namespace PROJECT.CustomerDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Customers] WHERE (([id] = @Original_id) AND ([Ad] = @Original_" +
                "Ad) AND ([Soyad] = @Original_Soyad) AND ([Adres] = @Original_Adres) AND ([Eposta" +
                "] = @Original_Eposta) AND ([Created_date] = @Original_Created_date))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [Ad] = @Ad, [Soyad] = @Soyad, [Adres] = @Adres, [Eposta] = @Eposta, [Created_date] = @Created_date WHERE (([id] = @Original_id) AND ([Ad] = @Original_Ad) AND ([Soyad] = @Original_Soyad) AND ([Adres] = @Original_Adres) AND ([Eposta] = @Original_Eposta) AND ([Created_date] = @Original_Created_date));
SELECT id, Ad, Soyad, Adres, Eposta, Created_date FROM Customers WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, Ad, Soyad, Adres, Eposta, Created_date FROM dbo.Customers";
        ...
        public virtual int Delete(int Original_id, string Original_Ad, string Original_Soyad, string Original_Adres, string Original_Eposta, System.DateTime Original_Created_date) {
        ...
        public virtual int Update(string Ad, string Soyad, string Adres, string Eposta, System.DateTime Created_date, int Original_id, string Original_Ad, string Original_Soyad, string Original_Adres, string Original_Eposta, System.DateTime Original_Created_date, int id) {
            if ((Ad == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Ad, string Soyad, string Adres, string Eposta, System.DateTime Created_date, int Original_id, string Original_Ad, string Original_Soyad, string Original_Adres, string Original_Eposta, System.DateTime Original_Created_date) {
            return this.Update(Ad, Soyad, Adres, Eposta, Created_date, Original_id, Original_Ad, Original_Soyad, Original_Adres, Original_Eposta, Original_Created_date, Original_id);
        }
    }
